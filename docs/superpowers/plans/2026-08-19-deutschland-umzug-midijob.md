...
Auftrag an Steuerberater (München, internationales Steuerrecht / Auslandskapitalerträge):

- Qualifikation der R$ 5.000 als Dividende (Kapitalertrag), nicht als Arbeitslohn.
- Abgeltungsteuer, Solidaritätszuschlag; kein DBA BR–DE mehr in Kraft (seit 2006) — Anrechnung ausländischer Quellensteuer auf private Dividenden grundsätzlich nach § 32d Abs. 5 EStG; § 34c EStG ist nicht der Regelfall, wenn Abgeltungsteuer/§ 32d greift; Sonderfälle hängen von Beteiligungsquote und Veranlagungswahl ab.
...
Steuerberater mit internationalem Steuerrecht / Auslandskapitalerträgen buchen (DATEV-Suche „international“, Stichwort Brasilien/Auslandskapital; kein lebendes DBA BR–DE). Briefing als PDF/Mail vorher schicken.
