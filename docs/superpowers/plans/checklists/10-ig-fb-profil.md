...
- [ ] Derselbe Pin-Gedanke als Feed-Post (Video oder Carousel) — **nicht** identischer Copy-Paste-Spam in 20 Gruppen am selben Tag.
- [ ] Gruppen: siehe `14-gruppen-und-regeln.md` (nativ, Regeln lesen).

## Verify

- Bio enthält „2 Zimmer“ und „teilt“.
- Highlight „Wohnung München“ existiert.
- Ein Pin ist live (Reel oder Carousel).
- Kein €-Betrag und kein „Midi-Job“ / „Dividende“ in Bio oder Pin-Caption.
